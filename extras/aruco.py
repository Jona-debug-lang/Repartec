    ...
    def process_image(self):
        ...
        if ids is not None:
            ...
            for i in range(len(ids)):
                ...
                if aruco_id == 2 and aruco_size >= 29816.0 and np.allclose(tvec, [0.01074322, 0.03501449, 0.50777197], atol=0.01):
                    self.stop_detected = True
                    rospy.loginfo("Detención por ArUco detectado")
...
def move_straight_27cm(pwm_left_speed, pwm_right_speed):
