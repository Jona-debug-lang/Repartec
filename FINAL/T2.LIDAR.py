...
# Función para ajustar el movimiento basado en la desviación del Lidar en el eje X
...
def handle_T1():
    move_straight(200, 97, 87, 'y')  # Corrección en eje Y
    ...
    move_straight(200, 96, 95, 'y')  # Corrección en eje Y
