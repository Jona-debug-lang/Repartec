...
# Función para mover los motores en línea recta hacia adelante con corrección (70 cm)
...
def handle_T2():
    ...
    done_pub.publish("Forward 70cm Done")
    rospy.loginfo("Mensaje 'Forward 70cm Done' publicado")
